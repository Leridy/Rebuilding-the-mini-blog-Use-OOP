    ...
    <div id="container">
        <main id="main" class="adm-main">
            <header id="login-header" class="main-header">
                <h1 class="login-h main-title">发布文章</h1>
            </header>
            <div class="card-box">
                <form action="handle-write-article.php" method="post" id="write-article">
                    <label for="w-atc-title" class="w-atc-label">标题：</label>
                    <input type="text" class="w-atc-inpt" name="atc-title" id="w-atc-title" placeholder="请输文章的标题" autofocus AutoComplete="off">
                    <label for="w-atc-author" class="w-atc-label">作者：</label>
                    <input type="text" class="w-atc-inpt" name="atc-author" id="w-atc-author" placeholder="这里填写作者名" AutoComplete="off">
                    <label for="w-atc-keywords" class="w-atc-label">关键词：</label>
                    <input type="text" class="w-atc-inpt" name="atc-keywords" id="w-atc-keywords" placeholder="这里填写关键词多个请用“,”隔开" AutoComplete="off">
                    <label for="w-atc-summary" class="w-atc-label">简介：</label>
                    <textarea  maxlength="200"  class="w-atc-textarea" name="atc-summary" id="w-atc-summary" placeholder="在这里输入简介 最多200字"></textarea>
                    <label for="w-atc-content" class="w-atc-label">正文：</label>
                    <textarea  maxlength="1500"  class="w-atc-textarea" name="atc-content" id="w-atc-content" placeholder="在这里输入正文内容 最多1500字"></textarea>
